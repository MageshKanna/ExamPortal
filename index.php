...
<body>
    ...
    <div id="container">
        <div id=demo1 class="login-Field col-xs-5">
            <center>
                <h2 style="font-weight: 900; font-family: sans-serif; font-variant: small-caps; text-align: center;">
                    Welcome to Exam Portal </h2>
            </center>
    ...
    <div class="row col-xs-12 col-xs-offset-1"><button class="btn btn-primary" onclick="exam()">Exam</button>
        <button class="btn btn-primary" onclick="checkResult()">Result</button>
    </div>
